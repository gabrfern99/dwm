...
static Key keys[] = {
	...
	{ MODKEY,			XK_p,			spawn,		SHCMD("mpc -h 192.168.1.11 toggle") },
	{ MODKEY|ShiftMask,		XK_p,			spawn,		SHCMD("mpc -h 192.168.1.11 pause ; pauseallmpv") },
	{ MODKEY,			XK_bracketleft,		spawn,		SHCMD("mpc -h 192.168.1.11 seek -10") },
	{ MODKEY|ShiftMask,		XK_bracketleft,		spawn,		SHCMD("mpc -h 192.168.1.11 seek -120") },
	{ MODKEY,			XK_bracketright,	spawn,		SHCMD("mpc -h 192.168.1.11 seek +10") },
	{ MODKEY|ShiftMask,		XK_bracketright,	spawn,		SHCMD("mpc -h 192.168.1.11 seek +120") },
	...
	{ MODKEY,			XK_comma,	spawn,		SHCMD("mpc -h 192.168.1.11 prev") },
	{ MODKEY|ShiftMask,		XK_comma,	spawn,		SHCMD("mpc -h 192.168.1.11 seek 0%") },
	{ MODKEY,			XK_period,	spawn,		SHCMD("mpc -h 192.168.1.11 next") },
	{ MODKEY|ShiftMask,		XK_period,	spawn,		SHCMD("mpc -h 192.168.1.11 repeat") },
	...
	{ 0, XF86XK_AudioPrev,		spawn,		SHCMD("mpc -h 192.168.1.11 prev") },
	{ 0, XF86XK_AudioNext,		spawn,		SHCMD("mpc -h 192.168.1.11 next") },
	{ 0, XF86XK_AudioPause,		spawn,		SHCMD("mpc -h 192.168.1.11 pause") },
	{ 0, XF86XK_AudioPlay,		spawn,		SHCMD("mpc -h 192.168.1.11 play") },
	{ 0, XF86XK_AudioStop,		spawn,		SHCMD("mpc -h 192.168.1.11 stop") },
	{ 0, XF86XK_AudioRewind,	spawn,		SHCMD("mpc -h 192.168.1.11 seek -10") },
	{ 0, XF86XK_AudioForward,	spawn,		SHCMD("mpc -h 192.168.1.11 seek +10") },
