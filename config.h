...
static char *fonts[]          = { "Fira Code:size=10:antialias=true:autohint=true", "JoyPixels:pixelsize=10:antialias=true:autohint=true", "FontAwesome:pixelsize=10:antialias=true:autohint=true",};
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_bracketleft,		spawn,		SHCMD("playerctl -p mpd position 120+") },
	...
	{ MODKEY|ShiftMask,		XK_comma,	spawn,		SHCMD("playerctl -p mpd position 15-") },
	{ MODKEY,			XK_period,	spawn,		SHCMD("playerctl -p mpd next") },
	{ MODKEY|ShiftMask,		XK_period,	spawn,		SHCMD("playerctl -p mpd position 15+") },
